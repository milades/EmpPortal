...
{
    /// <inheritdoc />
    public partial class InitialIdentityAndSessions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DirectoryObjectGuid = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Sid = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    DisplayName = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    IsDirectoryEnabled = table.Column<bool>(type: "bit", nullable: false),
                    LastDirectoryValidationAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationSessions_UserId_RevokedAtUtc",
                schema: "security",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_DirectoryObjectGuid",
                schema: "identity",
                table: "Users",
